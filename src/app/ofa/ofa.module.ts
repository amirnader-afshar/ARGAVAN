...
export const ROUTES: any = [
    {
        ...
        children: [
            ...
            { path: 'ofa/inLetters_archive', component: OutLettersComponent ,data:{LETTER_IN_OUT_TYPE:'in',archive:true,FLG_ENTERNAL:false}},
            { path: 'ofa/inLetters_archive_ENTERNAL', component: OutLettersComponent ,data:{LETTER_IN_OUT_TYPE:'in',archive:true,FLG_ENTERNAL:true}},
            { path: 'ofa/inLetter', component: outLettercomponent ,data:{LETTER_IN_OUT_TYPE:'in'}},
            { path: 'ofa/enternalLetter', component: outLettercomponent ,data:{LETTER_IN_OUT_TYPE:'in'}},
